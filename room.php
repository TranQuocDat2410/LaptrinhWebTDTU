...
?>
    <table  cellpadding="10" cellspacing="10" border="0" style=" background-color:white; border-collapse: collapse; margin: auto">
    <tr class="control" style="text-align: center; font-weight: bold; font-size: 30px">
        ...
        <tr class="control" style="text-align: left; font-weight: bold; font-size: 20px">
            <td colspan="4">
                <a href="add_room.php" class="btn btn-primary mr-auto">Thêm Thông Tin Phòng</a>
            </td>
            <td class="text-right">
